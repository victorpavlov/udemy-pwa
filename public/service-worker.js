...
workboxSW.router.registerRoute(
  'https://pwa-app-1da65.firebaseio.com/posts.json',
  function(args) {
...
workboxSW.precache([
  ...
  },
  {
    ...
    "revision": "2645a44cd2641297ab72694b9ed113ff"
  },
  {
  ...
  },
  {
    ...
    "revision": "741cd5e48e454b36922dbde14ae9c293"
  },
  {
    "url": "src/js/feed.min.js",
    "revision": "0291bd15a120aba68213eacf964dff12"
  },
  {
    ...
    event.waitUntil(
      readAllData('sync-posts').then(function (data) {
        for (var dt of data) {
          ...
          fetch(
            'https://us-central1-pwa-app-1da65.cloudfunctions.net/storePostData',
            {
              method: 'POST',
              body: postData,
            }
